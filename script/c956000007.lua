...
function s.spfilter(c,e,tp)
	return c:GetLevel()==6  and c:IsAttribute(ATTRIBUTE_FIRE) and c:IsSetCard(0x9993) and c:IsType(TYPE_PENDULUM) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
