...
EFFECT_REFLEXXION_MANIFEST = 954321026

--Parameters
-- c: The card that will be checked for code "EFFECT_REFLEXXION_MANIFEST".
function Card.IsManifestMonster(c)
	return c:IsHasEffect(EFFECT_REFLEXXION_MANIFEST)
end
...
function Card.IsAmbushMonster(c)
