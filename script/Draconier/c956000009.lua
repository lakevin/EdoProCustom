...
function s.spfilter(c,e,tp)
	return c:GetLevel()==6 and c:IsSetCard(SET_DRACONIER) and c:IsRace(RACE_DRAGON) and c:IsAttribute(ATTRIBUTE_EARTH) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
